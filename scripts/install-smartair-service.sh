...
# Do not use network-online.target: on WiFi it can take minutes or never complete, leaving
# the service stuck in "activating". This app + kiosk only need local loopback; WiFi can
# connect after start.
